...
void MyViewer::build_scene()
{
	...
	if (!model[0]->model()->load("C:/Users/mnguyen287/Downloads/arm/rupperarm.m")) {
	...
	if (!model[1]->model()->load("C:/Users/mnguyen287/Downloads/arm/rlowerarm.m")) {
	...
	if (!model[2]->model()->load("C:/Users/mnguyen287/Downloads/arm/rhand.m")) {
