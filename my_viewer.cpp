...
void MyViewer::add_model(SnShape* s, GsVec p)
{
	...
	//bool ok = snm->model()->load("C:/Users/mnguyen287/Downloads/arm/rhand.m");

	GsModel* gm = new GsModel();
	bool ok = gm->load("C:/Users/mnguyen287/Downloads/arm/rhand.m");
	SnModel* snm = new SnModel(gm);

	if (!ok) { gsout << "Could Not Load!\n"; gs_exit(1); }

	GsBox b;
	snm->get_bounding_box(b);
	gm->get_bounding_box(b);
	gsout << "bbox =" << b << gsnl;
